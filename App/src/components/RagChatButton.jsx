...
const RagChatButton = ({ onPress }) => {
    ...
    return (
        <TouchableOpacity
            style={[
                styles.button,
                {
                    ...
                    bottom: height * 0.25, // Slightly below center
                    right: 16 + insets.right // 16px margin from right edge
                }
            ]}
            onPress={onPress}
            activeOpacity={0.8}
        >
            ...
            <Text style={[theme.typography.bodySmall, styles.text]}>ChatAI</Text>
        </TouchableOpacity>
    );
};
